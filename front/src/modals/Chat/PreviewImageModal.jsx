      ...
      <div className="flex justify-between items-center mb-4 px-2">
        ...
        <div className="flex items-center gap-4">
          {isImageContent && (
            <>
              <button
                ...
                className="cursor-pointer p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded text-tertiary dark:text-gray-300"
                disabled={scale <= 0.5}
                aria-label="Zoom out"
              >
                <svg
          ...
          <button
            ...
            className="cursor-pointer px-3 py-1.5 bg-tertiary hover:bg-blue-600 rounded-2xl text-white font-medium text-sm transition-colors"
            aria-label="Save"
            title="Save file"
          >
            Save
