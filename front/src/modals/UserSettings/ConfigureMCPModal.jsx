// components/modals/ConfigureMCPModal.jsx
import { useState, useEffect } from "react";
import BaseModal from "../BaseModal";
import { Trans } from "react-i18next";

export default function ConfigureMCPModal({
  isOpen,
  onClose,
  initialValue = "",
  onSave,
  ...
  return (
    <BaseModal isOpen={isOpen} onClose={onClose} titleKey="MCP Server">
      <div className="flex flex-col gap-3">
        <p className="text-sm text-gray-600 dark:text-gray-300">
          <Trans i18nKey="modal.mcp_desc">
            Enter the MCP server string (e.g., <code>host:port</code> or a
            descriptor your app expects).
          </Trans>
        </p>
        <input
          autoFocus
          ...
          placeholder="e.g. jkunkel1/hpc-docs or host:1234"
