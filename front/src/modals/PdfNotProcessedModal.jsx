...
function PdfNotProcessedModal(props) {
  return (
      ...
      <div className="select-none border dark:border-border_dark rounded-2xl bg-white dark:bg-black w-full">
        <div className="flex justify-between items-center px-4 pt-4">
          <p className="text-xl text-tertiary">
            <Trans i18nKey="description.pdf_not_processed_title"></Trans>:
          </p>
          <img
            src={cross}
            alt="cross"
        ...
        <div className="flex flex-col gap-2 p-4">
          <div className="pt-0 pb-2">
            <p className="dark:text-white text-black text-justify">
              <Trans i18nKey="description.pdf_not_processed"></Trans>
            </p>
          </div>
...
export default PdfNotProcessedModal;
