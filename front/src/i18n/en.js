export default {
  ...
  settings: {
    ...
    label_audio_voice: "Voice",
    label_audio_language: "Language",
    audio_option_auto: "Auto (model default)",
    audio_language_english: "English",
    audio_language_german: "German",
    audio_voice_english_us_female: "English (US) • Female",
    audio_voice_english_us_male: "English (US) • Male",
    audio_voice_english_uk_female: "English (UK) • Female",
    audio_voice_english_uk_male: "English (UK) • Male",
    audio_voice_german_female: "German • Female",
    audio_voice_german_male: "German • Male",
    audio_sample_text_en: "Hello! This is a short voice sample.",
    audio_sample_text_de: "Hallo! Das ist eine kurze Stimmprobe.",
    audio_preview: "Preview voice",
    audio_preview_unavailable: "Preview not supported in this browser",
    audio_voice_unavailable: "This device doesn't provide that voice. Using default voice with pitch adjustment.",
  ...
  conversation: {
    ...
    speech_mode_title: "Speech mode",
    speech_mode_button: "Speech mode",
  ...
  persona: {
    ...
    customPersonaEmpty: "No custom personas yet",
    createFromConversation: "Create Persona",
    customPersonaSaved: 'Saved "{{title}}" as custom persona',
    customPersonaSaveError: "Failed to create custom persona",
    customPersonaImportError: "Failed to import custom persona",
    customPersonaRenameRequired: "Persona name cannot be empty",
    customPersonaRenameSuccess: 'Renamed persona to "{{title}}"',
    customPersonaRenameError: "Failed to rename custom persona",
    customPersonaDeleteTitle: "Delete Custom Persona",
    customPersonaDeleteConfirm: 'Delete custom persona "{{title}}"?',
    customPersonaDeleteSuccess: "Custom persona deleted",
    customPersonaDeleteError: "Failed to delete custom persona",
