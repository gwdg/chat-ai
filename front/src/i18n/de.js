export default {
  ...
  settings: {
    ...
    label_audio_voice: "Stimme",
    label_audio_language: "Sprache",
    audio_option_auto: "Automatisch (Standard)",
    audio_language_english: "Englisch",
    audio_language_german: "Deutsch",
    audio_voice_english_us_female: "Englisch (US) • weiblich",
    audio_voice_english_us_male: "Englisch (US) • männlich",
    audio_voice_english_uk_female: "Englisch (UK) • weiblich",
    audio_voice_english_uk_male: "Englisch (UK) • männlich",
    audio_voice_german_female: "Deutsch • weiblich",
    audio_voice_german_male: "Deutsch • männlich",
    audio_sample_text_en: "Hello! This is a short voice sample.",
    audio_sample_text_de: "Hallo! Das ist eine kurze Stimmprobe.",
    audio_preview: "Stimme anhören",
    audio_preview_unavailable: "Vorschau in diesem Browser nicht verfügbar",
    audio_voice_unavailable: "Diese Stimme ist auf dem Gerät nicht verfügbar. Es wird die Standardstimme mit angepasster Tonhöhe verwendet.",
  ...
  conversation: {
    ...
    speech_mode_title: "Sprachmodus",
    speech_mode_button: "Sprachmodus",
  ...
  persona: {
    ...
    customPersonas: "Eigene Personas",
    customPersonaEmpty: "Noch keine eigenen Personas",
    createFromConversation: "Persona erstellen",
    customPersonaSaved: '"{{title}}" als eigene Persona gespeichert',
    customPersonaSaveError: "Eigene Persona konnte nicht erstellt werden",
    customPersonaImportError: "Eigene Persona konnte nicht importiert werden",
    customPersonaRenameRequired: "Der Persona-Name darf nicht leer sein",
    customPersonaRenameSuccess: 'Persona in "{{title}}" umbenannt',
    customPersonaRenameError: "Eigene Persona konnte nicht umbenannt werden",
    customPersonaDeleteTitle: "Eigene Persona löschen",
    customPersonaDeleteConfirm: 'Eigene Persona "{{title}}" löschen?',
    customPersonaDeleteSuccess: "Eigene Persona gelöscht",
    customPersonaDeleteError: "Eigene Persona konnte nicht gelöscht werden",
