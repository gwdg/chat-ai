...
export default function SettingsDrawer({ localState, setLocalState, userData, modelsData }) {
  ...
  return (
    <>
      ...
      <div
        id="sidebardrawer"
        className={`fixed w-[80vw] md:w-[30vw] max-w-md top-[3.5rem] md:top-0 right-0 pt-4 z-40 h-[calc(100vh-3.5rem)] md:h-screen overflow-y-auto transition-transform duration-300
