  ...
  return (
    <div
      className={`relative flex-col items-center ${
        showAdvOpt ? "w-[40%] mobile:w-full flex p-2" : ""
      } p-2 text-tertiary flex flex-col gap-4`}
    >
      {/* Settings Panel */}
      <div
        className={`${
          showAdvOpt
            ? "w-[calc(100%-12px)] flex static mobile:absolute bottom-0 left-0"
            : "hidden"
      ...
      >
        <div
          ...
          } flex flex-col gap-4 sm:p-6 py-4 px-3 border dark:border-border_dark rounded-2xl shadow-lg dark:shadow-dark bg-white dark:bg-bg_secondary_dark h-fit w-full`}
        >
      ...
      <div
        className={`${
          showAdvOpt ? "flex p-2" : "mobile:flex hidden"
        } w-full mt-[YourFirstChildHeight]`}
      >
