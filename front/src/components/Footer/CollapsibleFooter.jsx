...
export default function CollapsibleFooter({ className = "" }) {
  const [open, setOpen] = useState(false);

  return (
    <footer
      className={`bg-white rounded-xl dark:bg-bg_secondary_dark text-sm select-none ${className}`}
    >
      ...
      <div className="relative">
        ...
        >
          <FontAwesomeIcon
            icon={faChevronUp}
            className={`size-5 text-tertiary transition-transform duration-200 ${
              open ? "rotate-180" : ""
            }`}
          />
        </button>
        ...
        <div className="absolute h-[3vh] left-0 top-0 flex items-center justify-center pl-3 gap-3">
          ...
          <div className="hidden md:flex md:flex-row justify-center items-center gap-4 dark:text-white text-black w-full md:p-0 py-2">
            <VersionDisplay />
          </div>
        ...
        <div className="interface-toggles absolute h-[3vh] right-0 top-0 flex items-center pr-3 gap-2">
          <p className="hidden md:block text-center w-full whitespace-nowrap overflow-visible text-gray-600 dark:text-gray-400">
      ...
      >
        ...
        <div
          className={`px-4 pb-2 pt-2 transition-opacity duration-200 ${
        ...
        >
          <div className="flex justify-between w-full">
            ...
            <div className="flex flex-col gap-3 items-center w-full">
              ...
              <div className="flex md:hidden justify-center text-center w-full flex-grow whitespace-nowrap overflow-visible text-gray-600 dark:text-gray-400 gap-x-2">
                <VersionDisplay />
                <Trans i18nKey="footer.iso_certified" />
              </div>
